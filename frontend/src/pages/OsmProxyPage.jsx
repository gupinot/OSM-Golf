...
export default function OsmProxyPage() {
  // Lu au montage (et non au niveau module) : avec la navigation client (sans reload),
  // revenir sur /osmproxy doit restaurer la dernière session écrite, pas l'état figé au
  // premier chargement de l'app.
